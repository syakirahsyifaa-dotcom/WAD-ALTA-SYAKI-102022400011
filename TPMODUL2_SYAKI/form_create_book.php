        ...
        <div class="card shadow p-4">
            ...
            <form action="create.php" method="POST">
                <div class="form-floating mb-3">
                    ...
                    <input type="text" class="form-control" name="tittle" placeholder="Judul Buku" required>
                ...
                <div class="form-floating mb-3">
                    ...
                    <select class="form-select" id="selectCategory" name="category" required>
                        <option value="<?= htmlspecialchars($category['id']) ?>" disabled selected>-- Pilih Kategori --</option>
