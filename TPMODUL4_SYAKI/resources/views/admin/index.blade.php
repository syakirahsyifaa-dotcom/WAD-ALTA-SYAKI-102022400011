        ...
        @if($products->count() > 0)
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 p-6">
                ...
                <div class="group bg-white border border-gray-200 rounded-xl hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col">
                    ...
                    <div class="relative w-full h-48 bg-gradient-to-br from-slate-100 to-slate-200 overflow-hidden">
                        @if($product->image)
                    ...
                    <div class="p-5 flex flex-col flex-1">
                        ...
                        <div class="pt-4 border-t border-gray-100 flex gap-2">
                            <a href="{{ route('admin.edit', $product) }}" class="flex-1 inline-flex items-center justify-center space-x-1 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 rounded-lg transition">
                            ...
                            <a href="{{ route('products.show', $product->id) }}" class="flex-1 inline-flex items-center justify-center space-x-1 bg-green-600 hover:bg-green-700 text-white font-semibold py-2 rounded-lg transition">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <form action="{{ route('admin.destroy', $product) }}" method="POST" class="flex-1" onsubmit="return confirm('Hapus produk ini secara permanen?')">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="w-full inline-flex items-center justify-center space-x-1 bg-red-600 hover:bg-red-700 text-white font-semibold py-2 rounded-lg transition">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
